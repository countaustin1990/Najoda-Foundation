  ...
  return (
    <div className="relative min-h-screen bg-gray-100 flex flex-col items-center justify-center">
      ...
      <button
        ...
        className="absolute top-4 left-4 bg-blue-400 text-gray-800 py-2 px-4 rounded-full font-semibold hover:bg-gray-300 transition duration-300"
      >
      ...
      <div className="w-full max-w-5xl bg-white rounded-lg shadow-lg p-8 md:p-12 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-blue-500 text-white py-3 rounded-full font-semibold hover:bg-blue-600 transition duration-300"
            >
              Send Message
            </button>
          </form>
